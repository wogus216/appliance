...
export const haierAppliances: Appliance[] = [
  {
    ...
    editorComment: '글로벌 가전 판매 1위 하이얼의 한국 시판 모델입니다. 조사 시점 40만원대로 이 카탈로그의 벽걸이 에어컨 중 가장 낮은 가격입니다. 셀프클리닝 기능이 차별점으로, 냉각→해동→건조 3단계로 열교환기 내부를 자동 세척합니다. A/S는 하이마트·쿠팡 무상A/S 채널로 접수 가능합니다.',
    status: 'best',
