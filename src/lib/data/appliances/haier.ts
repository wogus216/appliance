...
export const haierAppliances: Appliance[] = [
  {
    ...
    images: [],
    price: 409000,
    description: '하이얼 셀프클리닝 인버터 벽걸이 에어컨 6평형. 조사 시점 이 카탈로그 벽걸이 중 가장 낮은 가격.',
    oneliner: '6평형 셀프클리닝 벽걸이, 조사 시점 41만원대 최저가권',
    editorComment: '중국 가전 브랜드 하이얼의 한국 시판 모델입니다. 조사 시점 40만원대로 이 카탈로그의 벽걸이 에어컨 중 가장 낮은 가격입니다. 셀프클리닝 기능이 차별점으로, 냉각→해동→건조 3단계로 열교환기 내부를 자동 세척합니다. A/S는 하이마트·쿠팡 무상A/S 채널로 접수 가능합니다.',
    status: 'best',
    ...
    errorCodes: [
      ...
      },
      {
        ...
        solution: '냉매는 밀폐 계통이라 줄어들 이유가 없습니다. 부족하다면 누설이므로 보충만으로는 재발합니다. 하이얼 고객센터(1588-6645)에 누설 점검을 요청하고, 설치한 지 얼마 안 됐다면 설치업체에도 함께 문의하세요.',
        severity: 'high',
      },
      {
        code: 'E3',
...

  {
    ...
    oneliner: '10평형 셀프클리닝 벽걸이, 조사 시점 55만원대 가성비 4등급',
    editorComment: '6평형 CTH06QBW의 상위 모델로 10평형까지 커버합니다. 조사 시점 55만원대로, 33㎡를 담당하는 벽걸이 중에서는 낮은 구간이면서 셀프클리닝 기능까지 갖췄습니다. 안방이나 소형 거실에 가성비 옵션으로 좋습니다.',
    status: undefined,
  ...
  // === 냉장고 ===
  {
    ...
    errorCodes: [
      ...
      },
      {
        ...
        solution: '전원을 끄고 냉동실 내용물을 옮긴 뒤 성에가 저절로 녹기를 기다려(수동 제상) 재가동하세요. 열기구나 도구는 쓰지 마세요. 다시 표시되면 하이얼 고객센터(1588-6645)에 제상 부품 점검을 요청하세요.',
        severity: 'high',
      },
    ],
