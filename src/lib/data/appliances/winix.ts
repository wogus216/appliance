...
export const winixAppliances: Appliance[] = [
  ...
  // === 제습기 ===
  {
    ...
    editorComment: '위닉스 뽀송 16L는 \'제습기 입문 가성비\'의 대표격입니다. 같은 16L 제습량이면서 조사 시점 38만원대라 프리미엄 16L 모델보다 낮은 구간이고, 장마철 한 철 돌리려는 가정에 부담이 적습니다. 신발·구석 집중 건조 노즐과 4단계 제습을 갖췄지만, 앱 원격제어나 공기청정 같은 부가기능은 없습니다. 디자인·정숙성·스마트 기능보다 \'제습 본연 성능 + 가격\'을 우선하는 분께 잘 맞는, 우리 사이트 제습기 라인업의 mid 포지션 추천작입니다.',
    status: 'best',
    ...
    errorCodes: [
      ...
      },
      {
        ...
        solution: '물탱크를 끝까지 밀어 정위치에 다시 장착. 반복되면 위닉스 뽀송 제습기 서비스센터(1544-5081)에 점검 문의',
        severity: 'low',
      },
      {
        code: 'E2',
        ...
        solution: '전원을 끄고 10분 후 재가동. 반복되면 위닉스 뽀송 제습기 서비스센터(1544-5081)에 점검 문의',
        severity: 'medium',
      },
      {
        code: 'DF',
        ...
        solution: '실내온도 18℃ 이상에서 사용하고 전원을 재투입. 지속되면 위닉스 뽀송 제습기 서비스센터(1544-5081) 점검',
        severity: 'medium',
      },
      {
        code: 'E3',
        ...
        solution: '전원을 끈 뒤 약 3분 기다렸다가 다시 켜고, 멀티탭 대신 단독 콘센트에 연결. 매번 멈추면 위닉스 뽀송 제습기 서비스센터(1544-5081) 점검',
        severity: 'high',
      },
      {
        code: 'CF',
        ...
        solution: '필터를 분리해 흐르는 물에 세척 후 완전히 말려 재장착하고 알림을 리셋. 청소 후에도 표시가 남으면 위닉스 뽀송 제습기 서비스센터(1544-5081) 문의',
        severity: 'low',
      },
    ],
