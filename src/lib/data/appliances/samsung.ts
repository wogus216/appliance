    ...
    errorCodes: [
      {
        ...
        solution: '전원을 끄기 전에 냉동식품을 아이스박스나 다른 냉동실로 옮기세요. 문을 연 채 성에가 저절로 녹기를 기다렸다가 재가동합니다. 드라이버·칼 같은 도구로 긁으면 증발기 배관이 상하므로 쓰지 마세요. 반복되면 삼성전자 서비스센터(1588-3366)에 문의하세요',
        severity: 'medium',
      },
      {
        code: 'OF F',
...

  {
    ...
    errorCodes: [
      ...
      },
      {
        ...
        solution: '반나절 이상 걸리는 작업이므로 냉동식품을 먼저 아이스박스나 다른 냉동실로 옮기세요. 그다음 전원을 끄고 냉동실 문을 연 채 성에를 충분히 녹인 뒤 재가동합니다. 도구로 긁어내지 마세요 — 증발기 배관이 상합니다. 재가동 후에도 다시 뜨면 팬 모터 점검이 필요하므로 삼성전자 서비스센터(1588-3366)에 문의하세요',
        severity: 'high',
      },
      {
        code: '24 E',
        ...
        solution: '냉동식품을 옮긴 뒤 전원을 끄고 성에를 충분히 녹이면 일시적으로 풀릴 수 있습니다(도구로 긁지 마세요). 다만 제상 부품 자체 문제인 경우가 많아 재발 시 삼성전자 서비스센터(1588-3366) 점검을 권장합니다',
        severity: 'high',
      },
      {
        code: '39 E',
