...
export const samsungAppliances: Appliance[] = [
  ...
  // === TV (이동식·라이프스타일) ===
  {
    ...
    editorComment:
      'LG 스탠바이미의 강력한 경쟁작으로, 같은 이동식 카테고리에서 120Hz 고주사율과 터치스크린을 앞세웁니다. 게임·스포츠에서 부드러움이 확실히 체감되고, 화면 분리와 풀 모션(틸트·스위블·피벗) 스탠드로 활용도가 높습니다. 다만 100만원대 가격에 QHD 해상도라는 점은 국내 리뷰에서 가장 많이 지적되는 부분이고, 스탠드 포함 25.7kg의 무게와 3시간 배터리(경쟁작보다 1시간 짧음)도 아쉽습니다. "삼탠바이미"라는 별명이 붙을 만큼 스탠바이미와의 양강 비교가 활발한데, 국내 비교 리뷰의 결론은 대체로 "게임·스포츠 위주면 무빙스타일, 배터리·화면 분리 활용이면 스탠바이미"로 수렴합니다. 2026년 4월에는 무빙스타일 라인업이 최대 85형까지 확대돼 시리즈 자체가 삼성 TV의 주력 카테고리로 커지고 있습니다.',
    status: 'featured',
