...
export const samsungAppliances: Appliance[] = [
  ...
  // === TV (이동식·라이프스타일) ===
  {
    ...
    editorComment:
      'LG 스탠바이미의 강력한 경쟁작으로, 같은 이동식 카테고리에서 120Hz 고주사율과 터치스크린을 앞세웁니다. 움직임이 빠른 게임·스포츠 영상에 유리한 사양이고, 화면 분리와 풀 모션(틸트·스위블·피벗) 스탠드를 지원합니다. 다만 100만원대 가격에 QHD 해상도라는 조합은 이 값을 받아들이기 어렵게 만드는 대목이고, 스탠드 포함 25.7kg의 무게와 3시간 배터리(경쟁작보다 1시간 짧음)도 아쉽습니다. 스탠바이미와 나란히 놓으면 갈림길은 분명합니다 — 게임·스포츠에서 120Hz가 필요하면 무빙스타일이고, 배터리 시간과 화면 분리 활용이 우선이면 스탠바이미입니다. 2026년 4월에는 무빙스타일 라인업이 최대 85형까지 확대돼 시리즈 자체가 삼성 TV의 주력 카테고리로 커지고 있습니다.',
    status: 'featured',
