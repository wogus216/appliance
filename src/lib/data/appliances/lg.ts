  ...
  // === 냉장고 ===
  {
    ...
    errorCodes: [
      ...
      },
      {
        ...
        solution: '8시간 이상 걸리는 작업이라 냉장·냉동식품을 먼저 아이스박스나 다른 냉장고로 옮겨야 합니다. 그다음 전원코드를 뽑고 냉장·냉동 문을 활짝 열어 성에를 녹인 뒤 재가동하세요. 도구로 긁어내면 증발기 배관이 상하므로 저절로 녹기를 기다립니다. 그래도 코드가 반복되면 LG전자 서비스센터(1544-7777)로 점검을 요청하세요.',
        severity: 'medium',
      },
      {
        code: 'Er IF',
        ...
        solution: '8시간 이상 걸리므로 안에 든 식품을 먼저 옮기세요. 그다음 전원코드를 뽑고 문을 활짝 열어 성에를 녹인 뒤 재가동합니다. 도구로 긁지 말고 저절로 녹기를 기다리세요. 증상이 계속되면 LG전자 서비스센터(1544-7777)로 점검을 요청하세요.',
        severity: 'medium',
      },
      {
        code: 'Er rS',
