...
export const lgAppliances: Appliance[] = [
  ...
  // === 냉장고 ===
  {
    ...
    errorCodes: [
      ...
      },
      {
        ...
        solution: '8시간 이상 걸리는 작업이라 냉장·냉동식품을 먼저 아이스박스나 다른 냉장고로 옮겨야 합니다. 그다음 전원코드를 뽑고 냉장·냉동 문을 활짝 열어 성에를 녹인 뒤 재가동하세요. 헤어드라이어·온풍기를 대거나 도구로 긁어내면 라이너 변형·증발기 천공으로 이어지므로 저절로 녹기를 기다립니다. 그래도 코드가 반복되면 LG전자 서비스센터(1544-7777)로 점검을 요청하세요.',
        severity: 'medium',
      },
      {
        code: 'Er IF',
        ...
        solution: '8시간 이상 걸리므로 안에 든 식품을 먼저 옮기세요. 그다음 전원코드를 뽑고 문을 활짝 열어 성에를 녹인 뒤 재가동합니다. 열기구를 대거나 도구로 긁지 말고 저절로 녹기를 기다리세요. 증상이 계속되면 LG전자 서비스센터(1544-7777)로 점검을 요청하세요.',
        severity: 'medium',
      },
      {
        code: 'Er rS',
  ...
  // === TV (이동식·라이프스타일) ===
  {
    ...
    editorComment:
      '전작(FHD)에서 QHD로 해상도가 올랐고, α8 2세대 AI 프로세서와 webOS 24로 OTT·스마트 기능이 풍부합니다. 원터치로 화면만 떼어 태블릿처럼 쓰는 구조라 방·주방·침실을 옮겨 다니며 보기 좋습니다. 배터리는 공칭 최대 4시간이며 밝기를 높이면 짧아지고, 60Hz 주사율도 아쉬운 점입니다. 다만 2026년 들어 해외에서 30% 안팎 할인이 자주 등장해 가격 부담은 줄고 있습니다. 경쟁작 무빙스타일과는 "120Hz·이동 편의 vs 돌비비전·배터리·화면 분리"의 선택 구도가 형성돼 있습니다.',
    status: 'featured',
  ...
  },
  {
    ...
    editorComment:
      '스탠바이미 라인의 최상위 모델로, 32인치 4K 화면과 11.1.2채널 돌비 애트모스(버추얼) 입체음향을 갖췄습니다. 144Wh 배터리로 무선 최대 4시간 30분(LG 공식 표기)까지 늘었고, 터치 디스플레이·세로 회전을 지원합니다. 반면 60Hz 주사율은 그대로라 게이밍엔 부족하고, 높은 가격대와 스탠드 포함 20.3kg의 무게는 분명한 진입장벽입니다. 화질·사운드를 갖춘 프리미엄 이동식 TV를 원하는 사용자에게 어울립니다.',
    status: 'new',
