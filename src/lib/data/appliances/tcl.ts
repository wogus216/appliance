...
export const tclAppliances: Appliance[] = [
...

  {
    ...
    editorComment: '6평형 TAC-08CSD의 상위 모델로, 9평형(29.3m2)까지 커버합니다. 조사 시점 50만원대로 국산 동급보다 낮은 구간이면서 냉방 면적 29.3㎡를 담당합니다. 안방이나 소형 거실에 적합합니다. 다만 에너지효율은 6평형과 같은 4등급이라, 냉방 면적이 넓어진 만큼 장시간 가동에서는 전기요금 부담도 함께 커집니다.',
    status: undefined,
