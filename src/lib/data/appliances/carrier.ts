...
export const carrierAppliances: Appliance[] = [
  {
    ...
    errorCodes: [
      {
        ...
        cause: '온도센서 불량',
        solution: '전원 끄고 10분 후 재가동. 반복 시 캐리어에어컨 서비스센터 연락 (1588-8866)',
        severity: 'medium',
      },
      {
        code: 'E4',
        ...
        solution: '실외기 주변 청소 후 재가동. 반복 시 캐리어에어컨 서비스센터 연락 (1588-8866)',
        severity: 'medium',
      },
      {
        code: 'E5',
        ...
        solution: '전원을 끄고 흡입구 필터와 팬 주변의 이물질·먼지를 제거한 뒤 재가동하세요. \'E5\'가 계속 뜨면 팬모터 또는 배선 점검이 필요하므로 캐리어에어컨 서비스센터에 접수하세요 (1588-8866).',
        severity: 'medium',
      },
      {
        code: 'E6',
        ...
        solution: '차단기를 내렸다 5분 후 다시 켜서 일시적 오류인지 확인하세요. 반복되면 실내기·실외기 연결 배선과 단자 체결 상태 점검이 필요하므로 캐리어에어컨 서비스센터에 접수하세요 (1588-8866).',
        severity: 'high',
      },
      {
        code: 'CH',
        ...
        solution: '냉매 누설·충전은 가정에서 처리할 수 없습니다. 운전을 중단하고 실외기 배관 연결부의 기름때·결빙 흔적 정도만 눈으로 확인한 뒤, 누설 점검 및 냉매 충전을 위해 캐리어에어컨 서비스센터에 접수하세요 (1588-8866). 자가 충전은 위험하니 하지 마세요.',
        severity: 'high',
      },
      {
        code: 'LC',
        ...
        solution: '운전을 멈추고 실내기 하단과 배수 호스의 꺾임·이물질 막힘을 확인해 정리하세요. 호스 경로를 바로잡아도 누수가 계속되면 배수 펌프나 설치 상태 점검이 필요하므로 캐리어에어컨 서비스센터에 접수하세요 (1588-8866).',
        severity: 'low',
      },
    ],
    ...
    reviews: [
      ...
      },
      {
        ...
        rating: 2,
        text: '제품 자체는 무난한데 설치 기사 방문 일정 잡는 데 시간이 좀 걸렸고, 첫 설치 후 살짝 누수가 있어 재방문을 받았습니다. A/S 접수는 1588-8866로 했는데 연결까지 대기가 길었어요. 냉방은 잘 됩니다.',
        pros: ['냉방 성능', '저렴'],
    ...
    errorCodes: [
      {
        ...
        description: '실내 온도센서 이상',
        cause: '온도센서 불량',
        solution: '전원 끄고 10분 후 재가동. 반복 시 서비스센터 연락 (1588-8866)',
        severity: 'medium',
      },
      {
        code: 'E6',
