...
export const appleAppliances: Appliance[] = [
  // === 무선이어폰 ===
  {
    ...
    editorComment:
      '아이폰 사용자에게는 사실상 정답에 가깝습니다. H2 칩으로 노이즈 캔슬링이 에어팟 프로 2 대비 최대 2배(애플 공식 표기)로 강화됐고, 심박수 측정·청력 검사 등 헬스 기능과 다이내믹 헤드트래킹 공간음향까지 갖췄습니다. 같은 계정의 애플 기기 사이에서는 자동 전환을 지원합니다. 다만 안드로이드에서는 기능이 크게 제한되고 멀티포인트를 정식 지원하지 않으며, 가격도 높은 편입니다. 코덱이 SBC·AAC뿐이라 안드로이드에서 고해상 스트리밍을 노린다면 이점이 없고, 폼 인퓨즈드 팁은 소모품이라 교체 비용을 따로 감안해야 합니다.',
    status: 'best',
