...
export const appleAppliances: Appliance[] = [
  // === 무선이어폰 ===
  {
    ...
    price: 369000,
    description:
      '애플 에어팟 프로 3세대(A3063·A3064·A3122, USB-C). H2 칩 기반으로 전작 대비 최대 4배 강력해진 노이즈 캔슬링에 심박수 센서·실시간 통역·청력 보조까지 더한 애플 생태계 완성형 이어폰.',
    oneliner: 'ANC 최강 애플 완성형 이어폰',
    editorComment:
      '아이폰 사용자에게는 사실상 정답에 가깝습니다. H2 칩으로 노이즈 캔슬링이 업계 최고 수준까지 올라왔고, 심박수 측정·청력 검사 등 헬스 기능과 다이내믹 헤드트래킹 공간음향까지 갖췄습니다. 애플 기기 간 자동 전환도 매끄럽습니다. 다만 안드로이드에서는 기능이 크게 제한되고 멀티포인트를 정식 지원하지 않으며, 가격도 높은 편입니다. 코덱이 SBC·AAC뿐이라 안드로이드에서 고해상 스트리밍을 노린다면 이점이 없고, 폼 인퓨즈드 팁은 소모품이라 교체 비용을 따로 감안해야 합니다.',
    status: 'best',
