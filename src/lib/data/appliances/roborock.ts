...
export const roborockAppliances: Appliance[] = [
  // === 로봇청소기 ===
  {
    ...
    images: [],
    price: 1766390,
    description: '로보락 S8 프로 울트라는 6000Pa HyperForce 강력 흡입과 VibraRise 2.0 음파진동 물걸레를 결합한 프리미엄 로봇청소기다. 올인원 클린 스테이션이 자동 먼지비움·물걸레 세척·열풍건조까지 처리해 손이 거의 가지 않으며, Reactive 3D 장애물 회피와 PreciSense 라이다 맵핑으로 다층 구조 집도 정밀하게 청소한다. 로봇청소기 글로벌 강자 로보락의 상위 라인업으로, 조사 시점 시중가는 176만원대다.',
    oneliner: '6000Pa 강력 흡입 + 음파진동 물걸레, 자동 비움·세척·열풍건조까지 한 번에 끝내는 올인원 프리미엄 로봇청소기',
    editorComment: '로봇청소기 글로벌 강자 로보락의 플래그십급 모델로, 흡입·물걸레·유지관리 자동화를 모두 상위권으로 끌어올린 제품입니다. 6000Pa 흡입과 음파진동 물걸레, Reactive 3D 장애물 회피로 바닥 청소 완성도는 동급 최고 수준이고, 올인원 도크가 먼지비움·물걸레 세척·열풍건조까지 알아서 처리해 1~2주는 신경 쓸 일이 거의 없습니다. 단점은 조사 시점 176만원대라는 높은 가격과 도크가 차지하는 공간, 두꺼운 카펫·높은 문턱에서의 한계입니다. 손 안 대는 완전 자동 청소를 원하는 다층·중대형 가정이라면 1순위지만, 원룸·최소 예산이라면 자동비움만 되는 하위 모델이 더 합리적입니다.',
    status: 'best',
  ...
  },
  {
    ...
    features: [
      ...
      '다기능 도크: 자동 먼지비움 + 75℃ 온수 물걸레 세척 + 열풍건조 + 세제 투입',
